...
const AddressContent = (
  <div>
    <Accordion.Accordion panels={AdressColumns} className="Accordion-Accordion" />
  </div>
)
...
const DepartmentContent = (
  <div>
    <Accordion.Accordion panels={DepartmentColumns} className="Accordion-Accordion" />
  </div>
)
...
const EmployeeContent = (
  <div>
    <Accordion.Accordion panels={EmployeeColumns} className="Accordion-Accordion" />
  </div>
)
...
const RatingContent = (
  <div>
    <Accordion.Accordion panels={RatingColumns} className="Accordion-Accordion" />
  </div>
)
...
const RoleHistoryContent = (
  <div>
    <Accordion.Accordion panels={RoleHistoryColumns} className="Accordion-Accordion" />
  </div>
)
...
const TimeoffContent = (
  <div>
    <Accordion.Accordion panels={TimeoffColumns} className="Accordion-Accordion" />
  </div>
)

  const tablePanels = [
      { key: 'table-1', title: {content: 'Addresses', icon: 'table'}, content: { content: AddressContent } },
      { key: 'table-2', title: {content: 'Departments', icon: 'table'}, content: { content: DepartmentContent } },
      { key: 'table-3', title: {content: 'Employees', icon: 'table'}, content: { content: EmployeeContent } },
      { key: 'table-4', title: {content: 'Ratings', icon: 'table'}, content: { content: RatingContent } },
      { key: 'table-5', title: {content: 'RoleHistories', icon: 'table'}, content: { content: RoleHistoryContent } },
      { key: 'table-6', title: {content: 'Roles', icon: 'table'}, content: { content: RoleContent } },
      { key: 'table-7', title: {content: 'Timeoffs', icon: 'table'}, content: { content: TimeoffContent } }
    ]
...
const rootPanels = [
  { key: 'databaseName', title: {content: 'Tutorial-SQL', icon: 'database'}, content: { content: Level1Content } },
]
